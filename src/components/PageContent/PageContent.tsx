    ...
    return (
        ...
        >
                ...
                <div className='sm:pl-10 max-w-[85%] sm:max-w-full'>
                    {programDay.map(i => (
                        ...
                        >
                            ...
                            {i.place && <p className='mt-2 col-span-2 sm:col-auto'>{i.place}</p>}
                        </div>
                    ))}
            ...
            <section className='flex flex-col items-center'>
                <h2 className="sm:text-lg mb-6 text-center max-w-[85%]">Будем счастливы видеть Вас на нашем свадебном торжестве!</h2>
