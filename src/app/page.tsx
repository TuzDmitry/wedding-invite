...
import GuestsInviteTitle from "@/components/GuestsInviteTitle";

export default function Home() {

    return (
        <div
            className="flex flex-col items-center h-full min-h-screen pb-20 sm:p-20 bg-[#D0CABE] text-zinc-800"
        >
            <section className='pt-[300px] pb-10 bg-[#BFC2BD] flex flex-col items-center'>
                ...
                <div className='flex flex-col items-center border-[1.5px] border-black w-3/5 py-8'>
                    <GuestsInviteTitle/>
                    <p className='my-10 w-3/4 text-justify'>Мы решили написать свою историю «жили долго и счастливо», и
                        именно
                        поэтому нам так важно
                        оказаться в
                        окружении самых близких и дорогих людей. С огромной радостью приглашаем вас разделить с нами
                        этот
                        волнующий и незабываемый день — день нашей свадьбы!</p>
                    {/*<h2>Место и время</h2>*/}
            ...
            <section className='flex flex-col items-center pt-7'>
                ...
                <div className='grid grid-cols-[1fr_auto] font-arial my-10'>
                    <img className="tn-atom__img t-img loaded row-span-2 size-[100px]"
                         ...
                         alt=""/>
                    <p className='text-3xl'>14:00</p>
                    <p className='text-xl'>Свадебная церемония
                        <br/>(загс фрунзенского района Минск, просп. Пушкина, 55 )</p>
                    <img className="tn-atom__img t-img loaded row-span-2 size-[100px]"
                         data-original="https://static.tildacdn.com/tild3938-6233-4237-b437-363261646136/2.png"
                         src="https://optim.tildacdn.com/tild3938-6233-4237-b437-363261646136/-/resize/320x/-/format/webp/2.png.webp"
                         alt=""/>
                    <p className='text-3xl'>15:30</p>
                    <p className='text-xl'>Начало банкета
                    <br/>
                        ресторан &#34;Venner&#34; Минский район, Ждановичский сельсовет, 83
                    </p>
                    <img className="tn-atom__img t-img loaded row-span-2 size-[100px]"
                         data-original="https://static.tildacdn.com/tild3938-6233-4237-b437-363261646136/2.png"
                         src="https://optim.tildacdn.com/tild3938-6233-4237-b437-363261646136/-/resize/320x/-/format/webp/2.png.webp"
                         alt=""/>
                    <p className='text-3xl'>23:00</p>
            ...
            <footer className='flex flex-col items-center mt-8 text-6xl font-allegro my-[60px]'>
                <p>Дмитрий и Екатерина</p>
            </footer>
            <section className='flex flex-col items-center'>
                <h2 className="text-2xl font-bold mb-4 font-arial">Будем очень рады видеть Вас через...</h2>
